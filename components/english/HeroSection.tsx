        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="hidden lg:flex items-center h-28">
            ...
            <div className="flex-grow flex justify-start items-start px-6">
              <p className="text-base lg:text-xl font-bold text-right">
                | The most innovative masterclass delivered live on Zoom | July 11–12, 2025
              </p>
            </div>
          ...
          <div className="lg:hidden">
            ...
            <div className="border-t border-white/20 mt-1 py-4">
              <p className="text-center text-xs font-bold sm:text-sm">
               | The most innovative masterclass delivered live on Zoom | June 11–12, 2025
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 sm:py-7 sm:pb-10">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
          ...
          <div className="text-right space-y-4 mx-auto lg:pl-10 lg:col-span-2">
            ...
            <h2 className="text-xl sm:text-lg font-semibold lg:pb-3 sm:pb-8 md:pb-2  text-center text-[#545454] leading-relaxed">
            ...
            <p className="text-[#545454] text-base pb-0 lg:text-xl sm:pb-8 text-center sm:text-lg leading-loose">
              A masterclass that blends Silicon Valley
              strategies, modern creativity and Ai tools,—
              helping you develop your project, make smarter
              decisions, and design a business that grows
              with confidence.
            </p>
          </div>
