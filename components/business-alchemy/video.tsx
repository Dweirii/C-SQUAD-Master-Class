  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto aspect-video rounded-none overflow-hidden shadow-lg bg-black">
      ...
      {!playing && (
        ...
        >
          <Image
            src="https://c-squad.b-cdn.net/Master-Class/1.png"
        ...
        <video
          ...
          controls={playing}
          poster="https://c-squad.b-cdn.net/Master-Class/1.png"
          preload="metadata"
          playsInline
          muted
        ...
        <source
          src="https://c-squad.b-cdn.net/Master-Class/Turquoise%20Green%20and%20Yellow%20Modern%20Travel%20Promo%20Video.mp4"
          type="video/mp4"
        />
