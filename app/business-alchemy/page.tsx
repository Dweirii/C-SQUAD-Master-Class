...
export default function Page() {
  return (
    <main>
      ...
      <ZoomBanner>
             قد تملك الشغف والرؤية، لكن بين الخوف، الغموض، وثِقل النمط التقليدي… تجد نفسك عالقًا. وهنا تبدأ خيمياء الأعمال: مزيج من الحكمة والتفكير التصميمي، لتصمّم مشروعًا يُشبهك ويفتح لك طريق النجاح.
      </ZoomBanner>
